#!/usr/bin/env python3
"""
Dump a raw Livox Mid-360 pcap into a flat binary that both the Rust rustlio2
...
Parsing mirrors rustlio2's parse_livox_custom_msg / parse_imu_cdr exactly:
  ...
  - lidar points kept where line<4 and (tag&0x30) in {0x10,0x00}, range-gated,
    ...
    consecutive-duplicate drop rustlio2 applies.
