# Rust port of the global FPFH+RANSAC relocalizer vs. the C++ original — outdoor_small_loop

`rust/src/bin/reloc_rust.rs` is a from-scratch Rust port of the global
...
C++ global    32   44%     41%     0.010   0.09°   14/32  17/32   41.6s
```

**Result: the Rust port matches the C++ original** — same centimetre accuracy
