# Relocalization on outdoor_small_loop — stock ICP vs. the global FPFH+RANSAC
...
- global: `global_reloc_bench` (C++ port of dimos
...
Production pattern: **global FPFH+RANSAC for cold-start / kidnapped recovery → hand its
